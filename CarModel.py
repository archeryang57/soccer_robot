...
class CarModel(pygame.sprite.Sprite):
    ...
    def set_steeringAngle(self, steeringAngle ):
        if steeringAngle > self.maxSteeringAngle :
            self.steering_angle = self.maxSteeringAngle
        elif steeringAngle < -self.maxSteeringAngle:
            self.steering_angle = -self.maxSteeringAngle
        else:
